...
public class SipServiceUtils {
    ...
    /**
     * Starting from pjsip 2.13 call logs are no longer generated by default but only if log level is >= 3
     * <a href="https://github.com/pjsip/pjproject/pull/3020">GitHub Pull request</a>
     * By setting this flag to true we force the minimum log level to three to get the call stats back
     */
    public static boolean RESTORE_CALL_STATS_GENERATION = false;
    ...
    public static void setSipLogger(EpConfig epConfig) {
        ...
        logCfg.setLevel(ENABLE_SIP_LOGGING ? 5 : getLowerLogLevel());
    }
    ...
    private static int getLowerLogLevel() {
        return RESTORE_CALL_STATS_GENERATION ? 3 : 0;
    }
}
